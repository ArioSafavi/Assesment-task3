...
---
## Flow chart and Psuedocode
![flowchart](flowchart_1.png)
![flowchart](flowchart_2.png)
![flowchart](flowchart_3.png)
![flowchart](flowchart_4.png)
![flowchart](flowchart_5.png)
![flowchart](flowchart_6.png)
...
Move player up  
ELSE IF ‘E’ is pressed THEN  
	IF there something interactable in range THEN Interact   
...
BEGIN level  
Input gamestate  
IF level is enemy level  
	While enemies alive  
		Don not let player go to next level  
	WHILE game object not collected  
		Do not let player go to next level  
...
BEGIN point  
Input gamestate  
PULL time taken in seconds  
PULL enemies defeated  
Score 1 = time taken in seconds x 10  
Score 2 =  enemies defeated x 20  
Final score = ADD score 1 and score 2  
DISPLAY final score  
END point  
...
IF user wants to save  
	...
	Save progress and high score to json file  
END save  

BEGIN Load  
Input userInput  
IF user wants to load save file  
	IF there is a save file  
		Load save file  
	ElseIF   
	Say there is no save file  
	Bring the game up  
END load  
---
## Story Boards
![flowchart](game_chart.png)
---
## Gantt Chart
![GanttChart](ganntchart.png)